...
module.exports = {
    ...
    callback: async (client, interaction) => {
      ...
      try {
        ...
        if(broke){
            interaction.reply(`Esta broke já existe. Utilize o comando **/broke-update** se deseja atualizar as informações.`);
        } else {
            ...
            await newBroke.save().catch((e) => {
                interaction.reply(`Erro ao gravar dados no banco: ${e}`);
                return;
              });

            interaction.reply(`A broke do pokemon **#${pokemonDex} ${pokemonName}** foi cadastrada com sucesso.\n\nBroke: ${pokemonBroke}`);
        }
